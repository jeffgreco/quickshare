services_lib['twitter'] = {
    extractParams: function($share_link) {
        var params = _defaultParams($share_link),
        	...
        	tweet_hashtags = _getData($share_link, 'tweet-hashtags'),
    ...
    makeUrl: function(params) {
        var href_url = 'https://twitter.com/intent/tweet?url=' + params.src_url + _mightInclude('&text=', params.tweet_body) + _mightInclude('&via=', params.via_username)  + _mightInclude('&hashtags=', params.tweet_hashtags);
